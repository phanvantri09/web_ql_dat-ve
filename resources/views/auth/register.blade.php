                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="row mb-3">
                                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Nhập Số Điện Thoại') }}</label>
                                    ...
                                    <div class="new-account mt-3">
                                        <p>Bạn Có Tài Khoản Chưa <a class="text-primary" href="{{ route('login') }}">Đăng Nhập</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
